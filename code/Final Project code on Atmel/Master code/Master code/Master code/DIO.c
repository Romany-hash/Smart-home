/**
 * @file DIO.c
 * @brief Digital I/O driver implementation file.
 * @details This file contains the implementation of functions for Digital I/O operations.
 * It provides functions for setting pin direction, writing to pins, and reading from pins.
 * 
 * @author Romany Sobhy 
 */
