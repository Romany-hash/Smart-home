 ...
 * @brief Configuration file for Digital Input/Output (DIO) pins.
 * @details This file contains the configuration for various input and output pins, including
 *          the ports and pins for LEDs, keypad, and LCD. It defines the ports and pins for each
 *          component for easy configuration and access in the main application code.
 *@author Romany Sobhy
 */
