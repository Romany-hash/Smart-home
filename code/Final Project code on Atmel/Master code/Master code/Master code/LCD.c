 ...
 *
 * @file LCD.c
 * @brief Implementation of functions for LCD initialization and communication.
 * @details This file contains the implementation of functions for initializing and communicating with an LCD module.
 *          It provides functions for initializing the LCD, sending commands and characters to the LCD, and controlling
