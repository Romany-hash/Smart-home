 ...
 * @details This file contains function prototypes and definitions for controlling LEDs connected to a microcontroller.
 * It provides functionality to initialize the LEDs, turn them on and off, and toggle their state.
 * 
 * @author Romany Sobhy
 */
