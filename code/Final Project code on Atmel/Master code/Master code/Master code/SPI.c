/**
 * @file SPI.c
 * @brief SPI communication functions.
 * @details This file contains the implementations of SPI communication functions.
 * It includes functions to initialize SPI, transmit and receive data over SPI.
 * 
 * @author Romany Sobhy
 */
