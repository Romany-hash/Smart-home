 ...
 * @brief Source file for keypad driver functions.
 * @details This file contains the implementation of functions for initializing the keypad
 * and checking for key presses.
 * 
 * @author Romany Sobhy
 */
