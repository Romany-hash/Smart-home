 ...
 * @details This file contains function prototypes and constants for the keypad driver.
 * It provides functions for initializing the keypad and checking for key press.
 * 
 * @author Romany Sobhy
 */
