 ...
 * @details This file contains the entry point of the program and the main logic of the application.
 * It initializes variables, configures peripherals, and implements the main functionality of the project.
 *
 * @author Romany Sobhy
 */
