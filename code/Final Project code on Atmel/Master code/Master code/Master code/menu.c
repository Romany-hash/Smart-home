 ...
 * @details This file contains the implementations of menu functions for controlling devices and rooms.
 * It includes functions to compare PINs, handle menu options, and get user input for controlling devices.
 * 
 * @author Romany Sobhy
 */
