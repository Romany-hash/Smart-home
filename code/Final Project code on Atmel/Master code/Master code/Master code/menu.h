/**
 * @file menu.h
 * @brief Menu functions for controlling devices and rooms.
 * @details This file contains function prototypes and definitions for the menu options and device control.
 * It provides functionality to display the menu, handle user input, and control devices based on user selection.
 * 
 * @author Romany Sobhy
 */
#ifndef MENU_H_
