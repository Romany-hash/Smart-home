 ...
 * APP_slave_Macros.h
 *
 * @brief   Macros for the slave application.
 *
 * @details This header file defines macros for controlling various devices in the slave application,
 *          including air conditioning, TV, and room LEDs.
 *
 * @created 4/25/2021 12:47:55 PM
 * @author Romany Sobhy
 */
